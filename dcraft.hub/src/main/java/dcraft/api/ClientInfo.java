...
public class ClientInfo {
	...
	/*
	 * <ApiSession Name="h1" Class="dcraft.api.HyperSessionFactory" Host="localhost" Port="8443" Secure="True" NodeId="[nodeid]"  TargetThumbprint="[targetthumbprint]" />
	 */
	public void loadConfig(XElement config) {
		...
		this.secure = config.getAttributeAsBooleanOrFalse("Secure");
		
		this.nodeid = config.getAttribute("NodeId");
