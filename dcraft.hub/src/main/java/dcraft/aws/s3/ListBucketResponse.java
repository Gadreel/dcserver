...
public class ListBucketResponse extends Response {
    ...
    class ListBucketHandler extends DefaultHandler {
        ...
        public void endElement(String uri, String name, String qName) {
            System.out.println(uri + " - " + name + " - " + qName + " : " + this.currText.toString());
            ...
            //    this.nextMarker = this.currText.toString();
                ...
                this.nextMarker = this.keyEntry.key;
            } else if (name.equals("LastModified")) {
                try {
                    this.keyEntry.lastModified = this.iso8601Parser.parse(this.currText.toString()).toInstant();
