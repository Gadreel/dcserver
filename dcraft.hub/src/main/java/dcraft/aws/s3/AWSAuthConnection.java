...
public class AWSAuthConnection {
    ...
    public InfoResponse getInfo(String bucket, String key, Map<String,List<String>> headers) throws IOException {
        return new InfoResponse(makeRequest("HEAD", bucket, Utils.urlencode(key), null, headers));
    }
     ...
     * @throws IOException
     */
    public HttpURLConnection makeRequest(String method, String bucketName, String key, Map<String,String> pathArgs, Map<String,List<String>> headers)
        throws MalformedURLException, IOException
    {
     ...
     */
    public HttpURLConnection makeRequest(String method, String bucket, String key, Map<String,String> pathArgs, Map<String,List<String>> headers,
                                          S3Object object)
        throws MalformedURLException, IOException
    {
