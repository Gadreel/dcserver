...
public class StreamThree {
	...
	public static void main(String... args) throws Exception {
								...
								.with(XElement.tag("Secure")
										...
										.with(XElement.tag("Feature")
												...
												.with(XElement.tag("Op")
														.withAttribute("Name", "Transform")
														.with(XElement.tag("Request")
																.withAttribute("Type", "zName")
																.withAttribute("Required", "true")
														)
														.with(XElement.tag("RequestStream")
		...
		ListStruct ratings = ListStruct.list(
			RecordStruct.record()
		...
		ListSourceStream lss = ListSourceStream.of(ratings);
		
		ServiceRequest request = ServiceRequest.of("ChefData", "Ratings", "Transform")
			.wrapData(chef)
