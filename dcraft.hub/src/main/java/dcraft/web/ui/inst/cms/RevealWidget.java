...
public class RevealWidget extends Base implements ICMSAware {
	static public RevealWidget tag() {
		RevealWidget el = new RevealWidget();
		el.setName("dcm.RevealWidget");
		return el;
	}
	
	@Override
	public XElement newNode() {
		return RevealWidget.tag();
	}
