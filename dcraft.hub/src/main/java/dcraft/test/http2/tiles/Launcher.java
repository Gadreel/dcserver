...
package dcraft.test.http2.tiles;
...
public final class Launcher {
	static public Path resourcepath = null;

    public static void main(String[] args) {
    	System.out.println("open avail: " + OpenSsl.isAvailable());
    	System.out.println("alpn avail: " + OpenSsl.isAlpnSupported());
    	System.out.println("version: " + OpenSsl.versionString());
    	
		// Scanner let's use read user input
		try (Scanner scan = new Scanner(System.in, "UTF-8")) {
			System.out.println("Path to tiles: ");
			
			String tpath = scan.nextLine();
			
			resourcepath = Paths.get(tpath);
		}
