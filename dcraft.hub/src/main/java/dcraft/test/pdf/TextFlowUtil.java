...
import dcraft.test.pdf.ControlCharacters.BoldControlCharacter;
import dcraft.test.pdf.ControlCharacters.ColorControlCharacter;
import dcraft.test.pdf.ControlCharacters.ControlCharacterFactory;
import dcraft.test.pdf.ControlCharacters.ItalicControlCharacter;
import dcraft.test.pdf.ControlCharacters.NewLineControlCharacter;
import dcraft.test.pdf.IndentCharacters.IndentCharacter;
import dcraft.test.pdf.annotations.AnnotatedStyledText;
import dcraft.test.pdf.annotations.Annotation;
import dcraft.test.pdf.annotations.AnnotationCharacters;
import dcraft.test.pdf.annotations.AnnotationCharacters.AnnotationControlCharacter;
...
public class TextFlowUtil {
	...
	// TODO text = splitByControlCharacter(IndentCharacters.INDENT_FACTORY, text);
