...
public class StackEntry {
	...
	public void updateCallback(final IInstructionCallback cb) {
		...
		this.callback = new IInstructionCallback() {			
			@Override
			public void resume() throws OperatingContextException {
				cb.resume();
				old.resume();
			}
		};
    ...
    public Struct resolveValue(String val) {
    	...
    	if (val.startsWith("`")) 
			return StringStruct.of(val.substring(1));
    	
    	// otherwise just treat this as a string
		return StringStruct.of(val);
    }

	public void operate(Struct target, XElement source) throws OperatingContextException {
		// cleaning -- ScriptHub.operate(this, target, source);
	}
    ...
    public void addVariable(String type, String name) throws OperatingContextException {
    ...
    public void setLastResult(Struct val) throws OperatingContextException {
    	StackFunctionEntry func = this.queryFunctionStack();
    ...
    public void setLastResult(long code, Struct val) throws OperatingContextException {
    	StackFunctionEntry func = this.queryFunctionStack();
    ...
    public void setLastResult(OperationContext v)  throws OperatingContextException {
        /* TODO
    	StackFunctionEntry func = this.queryFunctionStack();
    	
    	if (func != null) {
	        func.setLastCode(v.getCode());
	        func.setLastResult(Struct.objectToStruct(v.getMessage()));
    	}
    	*/
    }
    ...
    public void run(IInstructionCallback cb) throws OperatingContextException {
    	this.callback = cb;
    	this.run();
    }
    
    public void run() throws OperatingContextException {
    	if (this.inst != null)
    		this.inst.run(this);
    }
