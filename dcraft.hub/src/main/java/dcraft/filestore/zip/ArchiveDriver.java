...
public class ArchiveDriver {  //extends RecordStruct implements IFileStoreDriver {
	...
	* /
	...
	@Override
	public void connect(RecordStruct params, OperationNoOutcome callback) {
	...
	@Override
	public void close(OperationNoOutcome callback) {
		// TODO reset scanner
	...
	public void getEntry(final String path, final OperationOutcome<ArchiveEntry> callback) {
		this.archive.getInputStream(new OperationOutcome<InputStream>() {			
			@Override
			public void callback() {
	...
	@Override
	public void getFileDetail(String path, OperationOutcome<IFileStoreFile> callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void getRootFolder(OperationOutcome<String> callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void setRootFolder(String path, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void addFolder(String path, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void removeFolder(String path, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
	...
	public void customCommand(RecordStruct params,
			OperationOutcome<RecordStruct> callback) {
		// TODO Auto-generated method stub
	...
	public void getFolderListing(String path,
			OperationOutcome<List<IFileStoreFile>> callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void getFolderListing2(String path, OperationOutcome<ListStruct> callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void put(IFileStoreFile source, boolean relative, OperationOutcome<IFileStoreFile> callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void putAll(IItemCollection files, boolean relative, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
