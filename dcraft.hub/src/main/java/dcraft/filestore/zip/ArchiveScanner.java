...
public class ArchiveScanner { /* extends RecordStruct implements IFileStoreScanner {
	...
	@Override
	public void scan(OperationOutcome<RecordStruct> callback) {
	...
	public class Matches implements IAsyncIterable<Struct>, IAsyncIterator<Struct> {
		...
		public void init(final OperationNoOutcome callback) {
			if (this.zin != null) {
				callback.completed();
				return;
			}
			
			ArchiveScanner.this.driver.archive.getInputStream(new OperationOutcome<InputStream>() {				
				@Override
		...
		@Override
		public void hasNext(final OperationOutcome<Boolean> callback) {
			this.init(new OperationNoOutcome() {
				@Override
				public void callback() {
		...
		@Override
		public void next(final OperationOutcome<Struct> callback) {
			this.init(new OperationNoOutcome() {
				@Override
				public void callback() {
