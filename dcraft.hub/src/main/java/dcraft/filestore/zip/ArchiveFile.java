...
public class ArchiveFile { /* extends RecordStruct implements IFileStoreFile {
    ...
    public ArchiveFile(ArchiveDriver driver, RecordStruct rec) {
		...
		this.driver.getEntry(cwd + "/" + this.getFieldAsString("Path"), new OperationOutcome<ArchiveEntry>() {			
			@Override
	...
	@Override
	public void copyTo(final OutputStream out, final OperationNoOutcome callback) {
		this.getInputStream(new OperationOutcome<InputStream>() {			
			@Override
			public void callback() {
	...
	public class DestinationDriver implements IDestinationDriver {						
		protected FileOutputStream out = null;	-- don't use fos
	...
	public class SourceDriver implements ISourceDriver {						
		protected FileInputStream in = null; -- don't use FIS
		...
		@Override
		public void collect(OperationOutcome<Block> callback) {
			try {
				Block b = new Block();
	...
	@Override
	public void openRead(Session session, final OperationOutcome<ISourceDriver> callback) {
		callback.setResult(new SourceDriver(session));
		callback.completed();
	}	

	@Override
	public void openWrite(Session session, final OperationOutcome<IDestinationDriver> callback) {
		callback.setResult(new DestinationDriver(session));
		callback.completed();
	}

	@Override
	public void hash(String method, final OperationOutcome<String> callback) {
	...
	@Override
	public void getInputStream(final OperationOutcome<InputStream> callback) {
		this.driver.archive.getInputStream(new OperationOutcome<InputStream>() {				
			@Override
			public void callback() {
	...
	@Override
	public void rename(String name, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void remove(OperationNoOutcome callback) {
		// TODO Auto-generated method stub
		
	}

	@Override
	public void setModificationTime(DateTime time, OperationNoOutcome callback) {
		// TODO Auto-generated method stub
