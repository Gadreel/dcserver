...
public class Worker implements Runnable {
	...
	protected TaskContext run = null;			// we are busy when not null 
	...
	public boolean resume(TaskContext tr) {
	...
	public void checkIfHung() {
		...
		if ((th == null) || ! th.isAlive())
			WorkHub.initSlot(this.slot);
		
		TaskContext tr = this.run;
	...
	public String toString() {
		TaskContext tx = this.run;
		
		if (tx != null)
			return tx.toString();
		
		Thread td = this.thread;
