...
import dcraft.db.work.IndexTenantTableField;
...
public class ReindexTenantTableField implements IUpdatingStoredProc {
	@Override
	public void execute(ICallContext request, OperationOutcomeStruct callback) throws OperatingContextException {
		Task task = Task.ofSubtask("ReIndex Tenant Table Field", "DB")
				.withParams(request.getData())
				.withTopic(WorkTopic.SYSTEM)
				.withTimeout(5)
				.withWork(IndexTenantTableField.of(request.getInterface()));
