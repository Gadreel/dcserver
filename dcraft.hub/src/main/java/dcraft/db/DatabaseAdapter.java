...
abstract public class DatabaseAdapter {
	...
	public ZonedDateTime getAsDateTime(Object... list) throws DatabaseException {
	...
	abstract public IConnectionManager getManger();

	abstract public String allocateSubkey();
	
	public Long inverseTime(ZonedDateTime time) {
		if (time == null)
			return null;
