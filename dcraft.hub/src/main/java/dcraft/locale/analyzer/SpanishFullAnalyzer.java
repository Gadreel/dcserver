 ...
 */
public final class SpanishFullAnalyzer extends StopwordAnalyzerBase {
  ...
  */
   ...
   */
  public SpanishFullAnalyzer(CharArraySet stopwords) {
   ...
   */
  public SpanishFullAnalyzer(CharArraySet stopwords, CharArraySet stemExclusionSet) {
    super(stopwords);
