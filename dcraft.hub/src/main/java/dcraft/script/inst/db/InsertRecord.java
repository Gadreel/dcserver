...
public class InsertRecord extends OperationsInstruction {
	static public InsertRecord tag() {
		InsertRecord el = new InsertRecord();
		el.setName("dcdb.InsertRecord");
		return el;
	}
	
	@Override
	public XElement newNode() {
		return InsertRecord.tag();
	}
	...
	public ReturnOption run(InstructionWork state) throws OperatingContextException {
		if (state.getState() == ExecuteState.READY) {
			...
			BaseStruct var = ResourceHub.getResources().getSchema().getType("dcdbInsertRecord").create();
