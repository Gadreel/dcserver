...
public class StandardSettingsObfuscator extends BasicSettingsObfuscator {
	static public StandardSettingsObfuscator obfus() {
	...
	public String decryptString(byte[] v) {
		...
		try {
			...
			Logger.error("Failed decryption: " + x, "Code", "203");
		}
	...
	public byte[] encryptString(CharSequence v) {
		...
		try {
			...
			Logger.error("Invalid settings key: " + x, "Code", "204");
		}
		catch(Exception x) {
			Logger.error("Failed decryption: " + x, "Code", "205");
		}
	...
	public boolean checkHashPassword(CharSequence candidate, CharSequence hashed) {
		...
		try {
			...
			Logger.error("Failed bcrypt password check: " + x);
		}
