...
import dcraft.util.pdf.ControlCharacters.BoldControlCharacter;
import dcraft.util.pdf.ControlCharacters.ColorControlCharacter;
import dcraft.util.pdf.ControlCharacters.ControlCharacterFactory;
import dcraft.util.pdf.ControlCharacters.ItalicControlCharacter;
import dcraft.util.pdf.ControlCharacters.NewLineControlCharacter;
import dcraft.util.pdf.IndentCharacters.IndentCharacter;
import dcraft.util.pdf.annotations.AnnotatedStyledText;
import dcraft.util.pdf.annotations.Annotation;
import dcraft.util.pdf.annotations.AnnotationCharacters;
import dcraft.util.pdf.annotations.AnnotationCharacters.AnnotationControlCharacter;
