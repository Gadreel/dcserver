package dcraft.util.json3.mumbers;
/**
 * References:
 * <dl>
...
import static dcraft.util.json3.mumbers.FastDoubleMath.DOUBLE_MIN_EXPONENT_POWER_OF_TEN;
import static dcraft.util.json3.mumbers.FastDoubleMath.MANTISSA_128;
import static dcraft.util.json3.mumbers.FastDoubleMath.MANTISSA_64;
import static dcraft.util.json3.mumbers.FastDoubleMath.fullMultiplication;
