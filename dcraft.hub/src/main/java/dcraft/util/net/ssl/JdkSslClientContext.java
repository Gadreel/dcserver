...
public final class JdkSslClientContext extends JdkSslContext {
     ...
     */
    public JdkSslClientContext(Path certChainFile) throws SSLException {
     ...
     *                            {@code null} to use the default.
     */
    public JdkSslClientContext(Path certChainFile, TrustManagerFactory trustManagerFactory) throws SSLException {
