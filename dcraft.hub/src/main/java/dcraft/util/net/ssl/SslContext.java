...
public abstract class SslContext {
     ...
     */
    public static SslContext newServerContext(Path certChainFile, Path keyFile) throws SSLException {
    ...
    public static SslContext newServerContext(
    		Path certChainFile, Path keyFile, String keyPassword) throws SSLException {
     ...
     */
    public static SslContext newServerContext(
    		Path certChainFile, Path keyFile, String keyPassword,
     ...
     */
    public static SslContext newServerContext(
            SslProvider provider, Path certChainFile, Path keyFile) throws SSLException {
     ...
     */
    public static SslContext newServerContext(
            SslProvider provider, Path certChainFile, Path keyFile, String keyPassword) throws SSLException {
     ...
     * @return a new client-side {@link SslContext}
     */
    public static SslContext newClientContext(Path certChainFile) throws SSLException {
    ...
    public static SslContext newClientContext(
    		Path certChainFile, TrustManagerFactory trustManagerFactory) throws SSLException {
     ...
     */
    public static SslContext newClientContext(
    		Path certChainFile, TrustManagerFactory trustManagerFactory,
            Iterable<String> ciphers, Iterable<String> nextProtocols,
            long sessionCacheSize, long sessionTimeout) throws SSLException {
     ...
     * @return a new client-side {@link SslContext}
     */
    public static SslContext newClientContext(SslProvider provider, Path certChainFile) throws SSLException {
     ...
     */
    public static SslContext newClientContext(
            SslProvider provider, Path certChainFile, TrustManagerFactory trustManagerFactory) throws SSLException {
