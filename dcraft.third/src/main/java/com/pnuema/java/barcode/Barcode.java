...
public class Barcode {
     ...
     */
    public BufferedImage encode(EncodingType iType, String stringToEncode, int width, int height) {
        setWidth(width);
        setHeight(height);
     ...
     * @return Image representing the barcode
     */
    public BufferedImage encode(EncodingType iType, String stringToEncode, Color foreColor, Color backColor, int width, int height) {
        setWidth(width);
        setHeight(height);
     ...
     * @return Image representing the barcode
     */
    public BufferedImage encode(EncodingType iType, String stringToEncode, Color foreColor, Color backColor) {
     ...
     * @return Image representing the barcode
     */
    public BufferedImage encode(EncodingType iType, String stringToEncode) {
     ...
     */
    private BufferedImage encode(EncodingType iType) {
        encodedType = iType;
        return encode();
    }
